...
class AddnewTypeWithKitchenName extends StatelessWidget {
  const AddnewTypeWithKitchenName({super.key,required this.model,required this.bloc});
    ...
    return Row(
      ...
      children: [
       ...
       model.itemsCount!=0? TextButton(
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewKitchenInGalleryView(
                galleryBloc: bloc,
                pagesGalleryEnum: PagesGalleryEnum.add,titleOfAppBar:model.typeName ,typeId:model.typeId ,)));
            },
            child: Text(
              "إضافة جديد",
